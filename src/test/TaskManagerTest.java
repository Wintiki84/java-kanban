...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    public void createAndGetSubTasks() {
        ...
        final Epic epic = new Epic("Epic", "Epic", Status.NEW);
        final SubTask subTask = new SubTask("SubTask1", "SubTask1", Status.NEW, epic.getId(),
                LocalDateTime.ofInstant(Instant.ofEpochSecond(0), ZoneOffset.UTC), 0);
    ...
    void getHistory() {
        ...
        final Epic epic = new Epic("Epic", "Epic", Status.NEW);
        taskManager.createEpic(epic);
        final SubTask subTask1 = new SubTask("SubTask1", "SubTask1", Status.NEW, epic.getId(),
                LocalDateTime.ofInstant(Instant.ofEpochSecond(0), ZoneOffset.UTC), 0);
        taskManager.createSubTask(subTask1);
        final SubTask subTask2 = new SubTask("SubTask2", "SubTask2", Status.NEW, epic.getId(),
                LocalDateTime.ofInstant(Instant.ofEpochSecond(0), ZoneOffset.UTC), 0);
